...
[x,fval,exitflag,output]=fsolve(@(x0)Dynamics_least_square_main(x0,x,y,z,Roll_now_degree,Pitch_now_degree, Yaw_now_degree, a_x,a_y,a_z,omega_x_d,omega_y_d,omega_z_d,v_x,v_y,v_z,omega_x,omega_y,omega_z,F_ex,F_ey,F_ez,M_ex,M_ey,M_ez,m_p),x0,options);
