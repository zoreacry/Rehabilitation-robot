function [Rope_Len]=kinematic_control(X_now)

x_now=X_now(1);
y_now=X_now(2);
z_now=X_now(3);
Roll_now_degree=X_now(4);
Pitch_now_degree=X_now(5);
Yaw_now_degree=X_now(6);
%---------------------------------------------------------------
...
%-------------------------------------------------------------------------
    Len_now(1)=sqrt((L1_point(1) - x_1_1 )^2+(L1_point(2) - y_1_1 )^2+(L1_point(3) - z_1_1 )^2);
    Len_now(2)=sqrt((L2_point(1) - x_2 )^2+(L2_point(2) - y_2 )^2+(L2_point(3) - z_2 )^2);
    Len_now(3)=sqrt((L3_point(1) - x_3 )^2+(L3_point(2) - y_3 )^2+(L3_point(3) - z_3 )^2);
    Len_now(4)=sqrt((L4_point(1) - x_4 )^2+(L4_point(2) - y_4 )^2+(L4_point(3) - z_4 )^2);
    Len_now(5)=sqrt((L5_point(1) - x_5 )^2+(L5_point(2) - y_5 )^2+(L5_point(3) - z_5 )^2);
    Len_now(6)=sqrt((L6_point(1) - x_6 )^2+(L6_point(2) - y_6 )^2+(L6_point(3) - z_6 )^2);
    Len_now(7)=sqrt((L7_point(1) - x_7 )^2+(L7_point(2) - y_7 )^2+(L7_point(3) - z_7 )^2);
    Len_now(8)=sqrt((L8_point(1) - x_8 )^2+(L8_point(2) - y_8 )^2+(L8_point(3) - z_8 )^2);
