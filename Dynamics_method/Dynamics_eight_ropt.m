function [T_Force]=Dynamics_eight_ropt(x,y,z,Pitch_now_degree,Yaw_now_degree,Roll_now_degree,a_x,a_y,a_z,omega_x_d,omega_y_d,omega_z_d,v_x,v_y,v_z,omega_x,omega_y,omega_z,F_ex,F_ey,F_ez,M_ex,M_ey,M_ez)
...
% T_Force=INV_J*(W_e+W_g-(M*X_DD+N*X_D));

T_Force=INV_J*(W_e-(M*X_DD+N*X_D));
