function [X_DD] = forward_Dynamics(x,y,z,Pitch_now_degree,Yaw_now_degree,Roll_now_degree,Rope_Force)
%UNTITLED2 This is Forward Dynamics code
%__----------------------------------_--------------------
m_p=5;
Pose=[x;y;z];
%---------------------------------------------------------------------------------------------------
